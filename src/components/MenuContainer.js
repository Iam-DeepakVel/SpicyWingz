...
const MenuContainer = () => {
  ...
  return (
    <section id="menu" className=" w-full-400 my-6">
        ...
        <div className=" w-full flex items-center justify-start lg:justify-center gap-8 py-6 overflow-x-scroll scrollbar-none">
          {categories?.map((category) => (
            <motion.div
              ...
              } hover:bg-cartNumBg w-24 min-w-[94px] h-28 cursor-pointer rounded-lg shadow-lg drop-shadow-xl flex flex-col gap-3 items-center justify-center`}
            >
              <div
